...
class EntrataPazienteForm(forms.Form):
    """
    Form per la gestionde degli utenti
    """
    def __init__(self, *args, **kwargs):
        modifica = kwargs.pop('modifica')
        super(EntrataPazienteForm, self).__init__(*args, **kwargs)

        self.fields['operatore'] = forms.fields.ChoiceField(widget=Select,choices=get_stato(), )
        self.fields['paziente'] = forms.fields.ChoiceField(widget=Select,choices=get_stato(), )

        self.fields['ora'] = forms.CharField(max_length=100)
